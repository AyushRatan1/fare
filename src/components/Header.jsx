...
import { brainwave, ved } from "../assets";
...
const Header = () => {
  ...
  return (
    <div
      ...
      } fixed top-0 left-0 w-full z-50 bg-n-8/90 backdrop-blur-sm border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm`}
    >
...
{
  /**
    item.onlyMobile: permet d'afficher certain lien sur mobile
*/
}
